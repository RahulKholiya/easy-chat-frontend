...
var import_react = /* @__PURE__ */ __toESM(require_react(), 1), e = { data: "" }, t = (t) => "object" == typeof window ? ((t ? t.querySelector("#_goober") : window._goober) || Object.assign((t || document.head).appendChild(document.createElement("style")), {
	innerHTML: " ",
	id: "_goober"
...
`, M = ({ toast: e }) => {
	...
	return t !== void 0 ? typeof t == "string" ? import_react.createElement(fe, null, t) : t : o === "blank" ? null : import_react.createElement(le, null, import_react.createElement(V, { ...s }), o !== "loading" && import_react.createElement(ue, null, o === "error" ? import_react.createElement(_, { ...s }) : import_react.createElement(w, { ...s })));
};
var ye = (e) => `
...
var _t = n;
//#endregion
export { w as CheckmarkIcon, _ as ErrorIcon, V as LoaderIcon, F as ToastBar, M as ToastIcon, Ie as Toaster, _t as default, T as resolveValue, n as toast, D as useToaster, I as useToasterStore };
